...
| `commerceActions` | `object[]` | from provider | Overrides provider default for commerce API patterns |
| `pageTypes` | `Array` | from provider | Overrides provider default for page type patterns |
