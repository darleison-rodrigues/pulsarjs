...
| `allowUnconfirmedConsent` | `boolean` | `false` | Allow data collection without explicit consent <!-- DOCS: C1 --> |
| `nonce` | `string` | `null` | CSP nonce for dynamic script tags <!-- DOCS: C1 --> |
| `commerceActions` | `object[]` | from provider | Array mapping actions to HTTP methods and patterns. Overrides provider default. <!-- DOCS: C1 --> |
| `pageTypes` | `Array` | from provider | Array mapping URL patterns to page types. Overrides provider default. <!-- DOCS: C1 --> |
