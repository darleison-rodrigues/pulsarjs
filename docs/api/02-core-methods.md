...
| `commerceActions` | `Array` | from provider | Array of commerce API patterns to map API calls to logical actions. <!-- DOCS: C1 --> |
| `pageTypes` | `Array` | from provider | Array of URL matchers to classify page views. <!-- DOCS: C1 --> |
